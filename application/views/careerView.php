            ...
            <div class="col-lg-4 col-md-6">
                <div class="card h-100 border-0 shadow-sm custom-hover-card rounded-4">
                    <div class="card-body text-center p-5">
                        ...
                        <p class="card-text text-secondary">Build next-generation applications using cutting-edge technologies and modern development practices.</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="card h-100 border-0 shadow-sm custom-hover-card rounded-4">
                    <div class="card-body text-center p-5">
                        ...
                        <p class="card-text text-secondary">Manage and optimize database performance for high-traffic applications.</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="card h-100 border-0 shadow-sm custom-hover-card rounded-4">
                    <div class="card-body text-center p-5">
                        ...
                        <p class="card-text text-secondary">Optimize cloud and server infrastructure for optimal performance.</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="career-detail active" id="software">
                    <div class="row align-items-center g-5">
                        ...
                        <div class="col-md-7">
                            ...
                            <p class="lead mb-4 text-secondary fs-6">Build next-generation applications using cutting-edge technologies and modern development practices.</p>
                            
                            <div class="premium-skill-list mb-5">
                                <span class="skill-badge"><i class="fas fa-check-circle"></i> HTML, CSS, JS</span>
                                <span class="skill-badge"><i class="fas fa-check-circle"></i> Laravel & CodeIgniter</span>
                ...
                <div class="visionary-card">
                    ...
                    <div class="visionary-content">
                        ...
                        <div class="visionary-text">
                            <h3 class="quote-text">
                                "At Suropriyo Enterprise, we don't just build technology &mdash; we build futures. Join us to create transformative solutions that redefine industries."
                            </h3>
